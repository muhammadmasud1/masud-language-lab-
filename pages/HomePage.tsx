  ...
  const heroSlides = [
    {
      ...
      title:
        lang === "BN" ? (
          <>
            নির্ভুলতা এবং গভীরতায় <span className="text-[#C1121F]">চাইনিজ</span>{" "}
            শিখুন
          </>
        ) : (
          <>
            Learn <span className="text-[#C1121F]">Chinese</span> with Precision
            & Depth
          </>
        ),
      description:
      ...
      image:
        "https://i.ibb.co.com/BVt9KnYL/file-00000000819071fdac0a25375e832d12-2.jpg",
      badge:
        lang === "BN"
          ? "সার্টিফায়েড চাইনিজ ইন্সট্রাক্টর"
          : "Certified Chinese Instructor",
    ...
    },
    {
      ...
      title:
        lang === "BN" ? (
          <>
            পেশাদার <span className="text-blue-600">অনুবাদ</span> এবং দোভাষী
            সেবা
          </>
        ) : (
          <>
            Professional <span className="text-blue-600">Translation</span> &
            Interpreting
          </>
        ),
      description:
      ...
      image:
        "https://i.ibb.co.com/YTZ3mxcV/Whats-App-Image-2026-05-19-at-10-21-51-PM.jpg",
    ...
    },
    {
      ...
      title:
        lang === "BN" ? (
          ...
          <>
            Top Quality Chinese <span className="text-orange-500">Books</span> &
            Resources
          </>
        ),
      description:
    ...
    <div className="overflow-x-hidden bg-white dark:bg-zinc-950 transition-colors">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto mb-16">
                  ...
                  <Link
                    to="/about"
                    className="px-12 py-6 bg-white dark:bg-zinc-900 text-zinc-900 dark:text-white border-2 border-zinc-100 dark:border-zinc-800 rounded-[2rem] font-black uppercase tracking-widest text-[14px] hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-all flex items-center justify-center gap-3"
                  >
                ...
                <div className="flex items-center gap-6">
                  <div className="flex -space-x-4">
                    {[1, 2, 3, 4, 5].map((i) => (
                      <img
                        ...
                        className="w-12 h-12 rounded-full border-4 border-white dark:border-zinc-950 shadow-xl object-cover"
                        alt=""
                      />
                    ))}
                  </div>
                  <div className="text-left">
                    ...
                    <p className="text-[12px] font-black text-zinc-400 uppercase tracking-widest">
                      {lang === "BN"
                        ? "১০০+ ছাত্রছাত্রীদের ভালোবাসা"
                        : "Loved by 100+ Students"}
                    </p>
                  </div>
                </div>
              </motion.div>
            ...
            >
              ...
              >
                ...
                <div>
                  <p className="text-[10px] font-black text-zinc-400 uppercase tracking-widest leading-none mb-1.5">
                    {lang === "BN" ? "HSK সাফল্য" : "HSK SUCCESS"}
                  </p>
              ...
              <div className="aspect-[4/5] rounded-[4rem] overflow-hidden bg-zinc-100 dark:bg-zinc-900 border-[16px] border-white dark:border-zinc-900 shadow-[0_80px_150px_-30px_rgba(0,0,0,0.4)] relative group">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-12 bg-gradient-to-t from-black/90 via-black/40 to-transparent">
                  <p className="text-zinc-300 font-bold uppercase tracking-widest text-[12px] mb-3">
                    MD. MASUD RANA
                  </p>
                  <h3 className="text-2xl md:text-3xl font-black text-white leading-[1.2] tracking-tight">
                    {lang === "BN"
                      ? "চাইনিজ দোভাষী এবং ভাষা প্রশিক্ষক"
                      : "Chinese Interpreter & Language Teacher"}
                  </h3>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              {
                label: lang === "BN" ? "ছাত্রছাত্রী" : "Students",
                value: "100+",
                icon: GraduationCap,
              },
              {
                label: lang === "BN" ? "বই বিক্রি" : "Books Sold",
                value: "1K+",
                icon: Book,
              },
              {
                label: lang === "BN" ? "প্রকল্প" : "Projects",
                value: "10+",
                icon: ShieldCheck,
              },
            ].map((stat, i) => (
              ...
              >
                ...
                <h3 className="text-5xl font-black text-zinc-900 dark:text-white mb-3">
                  {stat.value}
                </h3>
                <p className="text-[12px] font-black text-zinc-400 uppercase tracking-widest">
                  {stat.label}
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            <div className="text-center md:text-left">
              ...
              <p className="text-zinc-500 max-w-xl font-medium leading-relaxed">
                HSK প্রস্তুতি থেকে বিশেষায়িত ব্যবসায়িক চাইনিজ পর্যন্ত, আপনার
                লক্ষ্য অনুযায়ী আমাদের পাঠ্যক্রম রয়েছে।
              </p>
            </div>
            <Link
              to="/courses"
              className="flex items-center gap-2 text-[#C1121F] font-black text-sm uppercase tracking-widest hover:gap-3 transition-all group"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {COURSES.map((course, i) => (
              ...
              >
                ...
                {/* Content */}
                <h3 className="text-2xl font-black text-zinc-900 dark:text-white mb-4 tracking-tight group-hover:text-[#C1121F] transition-colors">
                  {course.title[lang]}
                </h3>
                ...
                <div className="flex items-center justify-between pt-8 border-t border-zinc-50 dark:border-zinc-800">
                  <div className="text-left">
                    ...
                    <p className="text-2xl font-black text-[#C1121F]">
                      {course.price}
                    </p>
                  </div>
                  <Link
                    to={`/checkout/${course.id}`}
                    className="w-14 h-14 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 rounded-full flex items-center justify-center hover:scale-110 transition-all shadow-lg active:scale-95"
                  >
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-red-50 dark:bg-red-950/20 text-[#C1121F] text-[12px] font-black mb-6 border border-red-100 dark:border-red-900/30 uppercase tracking-widest">
                ...
                <span>
                  {lang === "BN"
                    ? "আকর্ষণীয় কার্যক্রম গ্যালারি"
                    : "Interactive Activities Gallery"}
                </span>
              </div>
              <h2 className="text-4xl md:text-6xl font-black text-zinc-900 dark:text-white mb-6 tracking-tight leading-none">
                {lang === "BN"
                  ? "আমাদের কার্যক্রম গ্যালারি"
      ...
      <section className="py-24 px-6 bg-white dark:bg-zinc-950 overflow-hidden relative">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="flex-grow flex items-center justify-center">
                <div className="relative">
                  ...
                  <div className="w-48 h-48 rounded-full bg-zinc-800 border border-zinc-700 flex items-center justify-center relative z-10 overflow-hidden">
                    <img
                      src="https://picsum.photos/seed/live/300/300"
          ...
          >
            ...
            <Link
              to="/live-lab"
              className="inline-flex items-center gap-4 px-10 py-5 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 rounded-2xl font-black uppercase tracking-widest text-[13px] hover:scale-105 transition-all shadow-2xl group"
            >
      ...
      <section className="py-24 bg-white dark:bg-zinc-950 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 mb-16 text-center">
          <h2 className="text-5xl font-black mb-4 tracking-tight text-zinc-900 dark:text-white">
            {lang === "BN" ? "ছাত্র-ছাত্রীদের বিশ্বস্ত" : "Trusted by Students"}
          </h2>
          ...
          <div className="flex">
            ...
            >
              {[...TESTIMONIALS, ...TESTIMONIALS].map((testimonial, idx) => (
                ...
                >
                  {/* Watermark character */}
                  <div className="absolute top-0 right-0 p-10 opacity-[0.03] text-9xl chinese-font pointer-events-none select-none">
                    赞
                  </div>

                  <div className="flex gap-1 mb-6 text-gold">
                    {[1, 2, 3, 4, 5].map((s) => (
                      <Star key={s} className="fill-current w-3 h-3" />
                    ))}
                  </div>
                  ...
                  <div className="flex items-center gap-5">
                    <img
                      ...
                      className="w-14 h-14 rounded-2xl object-cover grayscale group-hover:grayscale-0 transition-all border border-zinc-100 dark:border-zinc-800"
                      alt={testimonial.name}
                    />
                    <div>
                      <h4 className="font-black text-zinc-900 dark:text-white uppercase tracking-wider text-sm">
                        {testimonial.name}
                      </h4>
                      <p className="text-[9px] font-black text-[#C1121F] uppercase tracking-[0.2em]">
                        {testimonial.role}
                      </p>
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-6 mt-16 text-center">
          <p className="text-zinc-400 font-bold uppercase tracking-widest text-[10px]">
            {lang === "BN"
              ? "১০০+ ছাত্রছাত্রীদের সাথে যোগ দিন"
      ...
      <section className="py-12 px-6 mb-20">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="absolute -bottom-20 -right-20 opacity-10 text-[35rem] chinese-font pointer-events-none select-none">
              书
            </div>

            <div className="relative z-10">
              <h2 className="text-5xl md:text-8xl font-black mb-8 tracking-tight leading-tight">
                চাইনিজ শিখতে প্রস্তুত?
              </h2>
              <p className="text-lg md:text-2xl opacity-80 max-w-2xl mx-auto mb-14 font-medium leading-relaxed">
                ১০০+ ছাত্র এবং পেশাদারদের সাথে যোগ দিন যারা আমাদের সাথে নতুন
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <Link
                  to="/quiz"
                  className="w-full sm:w-auto px-12 py-6 bg-white text-[#C1121F] rounded-3xl font-black uppercase tracking-widest text-xs flex items-center justify-center gap-3 shadow-2xl hover:bg-zinc-100 transition-all active:scale-95"
                >
                  <Sparkles className="w-5 h-5" /> ফ্রি কুইজ শুরু করুন
                </Link>
                <Link
                  to="/register"
                  className="w-full sm:w-auto px-12 py-6 bg-[#780000] text-white rounded-3xl font-black uppercase tracking-widest text-xs flex items-center justify-center gap-3 shadow-xl hover:bg-black transition-all active:scale-95"
                >
                  এখনি নিবন্ধন করুন
                </Link>
              </div>
